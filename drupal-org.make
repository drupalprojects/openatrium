...
projects[oa_core][version][branch] = 2.0-beta2

projects[oa_discussion][subdir] = contrib
projects[oa_discussion][version][branch] = 2.0-beta1

projects[oa_wiki][subdir] = contrib
projects[oa_wiki][version][branch] = 2.0-beta1

projects[oa_events][subdir] = contrib
projects[oa_events][version][branch] = 2.0-beta2

projects[oa_events_import][subdir] = contrib
projects[oa_events_import][version][branch] = 2.0-beta1

projects[oa_contextual_tabs][subdir] = contrib
projects[oa_contextual_tabs][version][branch] = 2.0-beta1

projects[oa_notifications][subdir] = contrib
projects[oa_notifications][version][branch] = 2.0-beta1
